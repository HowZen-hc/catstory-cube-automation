...
| 3-G-GLOVE | 珍貴/恢復 | 永恆/光輝 OR 一般裝備 | any | T | F | `三排潛能中至少一排為"爆擊傷害 +3%"，支援雙爆、3S、雙 S` |
| 3-G-HAT | 珍貴/恢復 | 永恆/光輝 OR 一般裝備 | any | F | T | `三排潛能中至少一排為"技能冷卻時間 -1 秒"，支援 -2 冷卻、3S、雙 S` |
...
_PHASE2_PRESET_TEMPLATES = {
    ...
    ("3line", "glove"):            '三排潛能中至少一排為"爆擊傷害 +3%"，支援雙爆、3S、雙 S',
    ("3line", "hat"):              '三排潛能中至少一排為"技能冷卻時間 -1 秒"，支援 -2 冷卻、3S、雙 S',
